...
# JB: update sql lite reference file
...
class Samples(db.Model):
    # __tablename__ = 'emoji'
    # JB: update sql source table
    __tablename__ = 'samples'

    # id = db.Column(db.Integer, primary_key=True)
    # JB: udpate sql table columns
...
def emoji_char_data():
    ...
    # results = db.session.query(Samples.otu_label, Samples.otu_id).\
    #     order_by(Samples.otu_id.desc()).\
    #     limit(10).all()
